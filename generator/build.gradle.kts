...
group = "akirolabs.tokengenerator"
version = "1.0.0"
...
springBoot {
    mainClass.set("akirolabs.tokengenerator.TokenGeneratorApplicationKt")
}
...
tasks.getByName("openApiGenerate") {
    ...
    setProperty("apiPackage", "akirolabs.tokengenerator.generated.api")
    setProperty("modelPackage", "akirolabs.tokengenerator.generated.model")
